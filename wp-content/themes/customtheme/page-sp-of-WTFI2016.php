<?php
/*
Template Name: Speakers of WTFI 2016
*/
get_header();
?>
<div class="container">
...
<div class="selector_block">
      ...
      <ul class="selector">
         ...
         <ul id="myDropdown3" class="dropdown3-content">
           <a href="/speakers-of-anoc/"><li>Another name of conference</li></a> 
            <a href="speakers-of-wealth-forum-2016/"><li>Another name of conference 2016</li></a>
         </ul>
      </ul>
   </div>
   ...
   <div class="speakers_block">
	...
	'numberposts' => -1,
	'category_name'    => 'speakers-of-WTFI2016',
	'orderby'     => 'date',
	'order'       => 'DESC',
	'post_type'   => 'post',
